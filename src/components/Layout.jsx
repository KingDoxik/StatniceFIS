...
export const navigation = [
  {
    title: 'Představení',
    links: [{ title: 'O této stránce', href: '/' }],
  },
  {
    title: 'Základy odborné práce',
    links: [
      {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link
          href="https://github.com/KingDoxik/StatniceFIS"
          className="group"
          aria-label="GitHub"
        >
          ...
          <article>
            {(title || section) && (
              <header className="mb-9 space-y-1">
                {section && (
                  <p className="font-display text-sm font-medium text-[#00957D]">
                    {section.title}
                  </p>
                )}
                {title && (
