...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-[#00957D] [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-[#00957D] [[data-theme=dark]_&]:block" />
